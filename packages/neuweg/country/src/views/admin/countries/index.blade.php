                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="dropdown dropdown-inline">
                        <button type="button" class="dataModel btn btn-brand btn-icon-sm"
                            data-id="#mainPanel"
                            data-href="{{ route('modules.countries.create') }}" >
                                        ...
                                        @foreach( $collection as $model )
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button
                                                        data-id="#mainPanel"
                                                        data-href="{{ route('modules.countries.edit', $model->id) }}"
                                                        class="btn-sm btn dataModel"
                                                        type="button"
                                                    > <i class="la la-edit"></i> </button>
                                                    <a
                                                        href="{{ route('modules.countries.delete', $model->id) }}"
...
@section('script')
    <script>
        $(document).ready(function(){
            ...
            $('.country-menu').addClass('kt-menu__item--active');
        });
    </script>
@stop
