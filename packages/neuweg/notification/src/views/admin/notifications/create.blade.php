...
@section('pageBar')
    <div class="kt-subheader__main">
        <div class="kt-subheader__breadcrumbs">
            ...
            <span class="kt-subheader__breadcrumbs-separator"></span>
            <a href="{{ route('modules.appNotifications.index') }}" class="kt-subheader__breadcrumbs-link">Notifications</a>
                ...
                <div class="kt-portlet__head-toolbar">
                    <!-- <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            href="{{ route('modules.appNotifications.create') }}"
                                data-title="Add new"
                            >
                    ...
                    <div class="kt-section__content">
                        ...
                        <div class="row">
                            <div style="border-right:1px solid lightgrey;" class="col-4 px-4">
                                {{ Form::open( [ 'class' => '', 'route' => 'modules.appNotifications.store', 'method' => 'POST', 'files' => true ]) }}
